#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Human Trafficking / Demand Indestructibility
============================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Human Trafficking (Demand Indestructibility).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "human_trafficking",
    "domain_name": "Human Trafficking",
    "theorem": "Demand Indestructibility",
    "classification": "Class 2 \u2014 Intractability",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 236.0,
    "channels": {
        "C1_victim_welfare": {
            "dist": "lognormal",
            "low": 2400,
            ...
            "high": 4200,
            "weight": 0.3,
            "description": "Direct victim welfare destruction (27.6M victims)"
        },
        "C2_labor_market": {
            "dist": "lognormal",
            "low": 500,
            ...
            "high": 1100,
            "weight": 0.25,
            "description": "Labor market distortion, wage depression"
        },
        "C3_governance": {
            "dist": "lognormal",
            "low": 250,
            ...
            "high": 800,
            "weight": 0.15,
            "description": "Governance corrosion, corruption, state complicity"
        },
        "C4_supply_chain": {
            "dist": "lognormal",
            "low": 250,
            ...
            "high": 600,
            "weight": 0.12,
            "description": "Consumer supply chain contamination"
        },
        "C5_intergenerational": {
            "dist": "lognormal",
            "low": 250,
            "mid": 380,
            "high": 550,
            "weight": 0.1,
            "description": "Intergenerational human capital destruction"
        },
        "C6_enforcement": {
            "dist": "normal",
            "low": 45,
            ...
            "high": 85,
            "weight": 0.08,
            "description": "Enforcement resource diversion"
        }
    },
    "impossibility_floor": 5.0
}
